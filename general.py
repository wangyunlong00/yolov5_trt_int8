...
# def non_max_suppression_cpu(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False,
#                         labels=(), standalone=False):
...
#     max_det = 300  # maximum number of detections per image
#     max_nms = 30000  # maximum number of boxes into torchvision.ops.nms()
#     time_limit = 10.0  # seconds to quit afteutils/general.pyr
#     redundant = True  # require redundant detections
#     multi_label &= nc > 1  # multiple labels per box (adds 0.5ms/img)
#     merge = False  # use merge-NMS
#
...
#         if standalone:
#             from nms import nms
#             keep, num_to_keep, parent_object_index = nms(boxes, scores, iou_thres, top_k=max_det)  # NMS
#             i = keep[:num_to_keep]
#         else:
#             i = torchvision.ops.nms(boxes, scores, iou_thres)  # NMS
#             if i.shape[0] > max_det:  # limit detections
